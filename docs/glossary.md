...
- **mesh:** a network of radio nodes that exchange messages and repeat
...
- **portable station:** a radio transceiver
...
- **station:** a radio transmitter with an associated identity or callsign
