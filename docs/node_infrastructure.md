...
- **Power** Infrastructure nodes will need to be supplied with reliable power 24/7.  Nodes of this nature commonly use solar panels and a large (for the node) sized battery.  Check the [Build Resources](/build_resources/) for more information
